...
//           navigate("/devicedata");
//         } else {
//           setErrorDialog("Access Denied: Only admins can view this page.");
//         }
//         break;
//       default:
//         break;
...
//         <div className="create-shipment-bottom">
//           <div className="create-shipment-left">
//             <label htmlFor="poNumber">PO Number*</label>
//             <input
//               type="text"
//               name="poNumber"
...
//         <div className="create-shipment-buttons">
